# Angular4 MEAN - QuickStart application with ExpressJS, MongoDB, Gulp and Typescript (Repository Pattern)
...
Fork of https://github.com/moizKachwala/Angular2-express-mongoose-gulp-node-typescript 
